...
function policy() {
    return (
        <div className="container">
            <h1 className="mt-5">Poubelle - iOS App</h1>
            <hr />
            ...
            <p>
                ...
                rights related to it, still belong to Charles Kremer.
            </p>
            <p>
                Charles Kremer is committed to ensuring that the app is as useful and
            ...
            <p>
                The Poubelle app stores and processes personal data that you have provided
                ...
                features and it could mean that the Poubelle app won’t work properly or at
                all.{" "}
            </p>
            <p>
                You should be aware that there are certain things that Charles Kremer will
                ...
                provided by your mobile network provider, but Charles Kremer cannot take
            ...
            <p>
                ...
                still apply. As a result, you may be charged by your mobile provider for the
                cost of data for the duration of the connection while accessing the app, or
                other third party charges. In using the app, you’re accepting responsibility
                for any such charges, including roaming data charges if you use the app
                outside of your home territory (i.e. region or country) without turning off
                data roaming. If you are not the bill payer for the device on which you’re
                using the app, please be aware that we assume that you have received
                permission from the bill payer for using the app.
            </p>
            <p>
                Along the same lines, Charles Kremer cannot always take responsibility for
                ...
                Service, Charles Kremer cannot accept responsibility
            </p>
            <p>
                With respect to Charles Kremer’s responsibility for your use of the app,
                when you’re using the app, it’s important to bear in mind that although we
                endeavour to ensure that it is updated and correct at all times, we do rely
                on third parties to provide information to us so that we can make it
                available to you. Charles Kremer accepts no liability for any loss, direct
            ...
            <p>
                ...
                on iOS – the requirements for system(and for any additional systems we
                decide to extend the availability of the app to) may change, and you’ll need
                to download the updates if you want to keep using the app. Charles Kremer
                does not promise that it will always update the app so that it is relevant
                to you and/or works with the iOS version that you have installed on your
            ...
            <p>
                ...
                of any changes by posting the new Terms and Conditions on this page. These
            ...
            <p>
                {" "}
                Charles Kremer built the Poubelle app as a Commercial app. This SERVICE is
                provided by Charles Kremer and is intended for use as is.
            </p>
            <p>
            ...
            <p>
                ...
                and Conditions, which is accessible at Poubelle unless otherwise defined in
                this Privacy Policy.
            </p>
            <p>
